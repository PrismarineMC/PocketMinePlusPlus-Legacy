...
public
function getBlockSkyLight($x, $y, $z)
{
    return $this->sections[$y >> 4]->getBlockSkyLight($x, $y & 0x0f, $z);
}

public
function setBlockSkyLight($x, $y, $z, $data)
{
    try {
...
public
function setBlockLight($x, $y, $z, $data)
{
    try {
...
public
function getBlockDataColumn($x, $z)
{
    $column = "";
    for ($y = 0; $y < Chunk::SECTION_COUNT; ++$y) {
...
public
function getBlockSkyLightColumn($x, $z)
{
    $column = "";
    for ($y = 0; $y < Chunk::SECTION_COUNT; ++$y) {
...
public
function getBlockLightColumn($x, $z)
{
    $column = "";
    for ($y = 0; $y < Chunk::SECTION_COUNT; ++$y) {
...
public
function isSectionEmpty($fY)
{
    return $this->sections[(int)$fY] instanceof EmptyChunkSection;
}

public
function getSection($fY)
{
    return $this->sections[(int)$fY];
}

public
function setSection($fY, ChunkSection $section)
{
...
private
function setInternalSection($fY, ChunkSection $section)
{
    $this->sections[(int)$fY] = $section;
    $this->hasChanged = \true;
}
...
public
function getBlockSkyLightArray()
{
    $skyLight = "";
    for ($y = 0; $y < Chunk::SECTION_COUNT; ++$y) {
